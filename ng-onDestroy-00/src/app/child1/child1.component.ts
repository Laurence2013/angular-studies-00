import { Component, Input, OnChanges, SimpleChanges, OnInit, 
	ViewChild, ElementRef, DoCheck , AfterContentInit, ContentChild, 
	AfterContentChecked, AfterViewChecked, OnDestroy } from '@angular/core';
...
export class Child1Component implements OnChanges, OnInit, DoCheck, 
	...
	public ngOnDestroy():void {
		console.log('Child1Component - ngOnDestroy() hook called!');
	}
}
